    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0;background-color:#367FA9;">
            <div class="navbar-header">
				...
				Welcome <?php echo $_SESSION['uname']; ?></span></a>
               ...
               <!-- <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="http://localhost/phpmyadmin/sql.php?server=1&db=visitordb&table=admin&pos=0&token=940d60169d5f056882c3b290af2fabcb"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" style="background-color:#367fa9;">
                        ...
                        <li>
                          ...
                          <ul class="nav nav-second-level">
                                <li>
                                    <a style="color:white" href="emp_reg.php">Employee Registration</a>
                                </li>
                                
								<li>
								<a style="color:white" href="emp_list.php">Employee List</a>
								</li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
