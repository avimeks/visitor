...
$query1=mysql_query("select * from emp_reg where id='$id'");
...
<td><input type="text" name="ph_no" value="<?php echo $row['phno'];?>" class="form-control" required></td>
</tr>
<tr>
<td>
...
<td><input type="email" name="aemail" value="<?php echo $row['alemail'];?>" class="form-control" required></td>
</tr>
<tr>
<td>
<label>Working Time</label></td>
<td><input type="time" name="wtime" value="<?php echo $row['working_time'];?>"  required>
</td>
</tr>
<tr>
<td>
...
<td><input type="text" name="dpmt" value="<?php echo $row['dpmt'];?>" class="form-control" required></td>
</tr>
<tr>
<td>
<label>Designation</label></td>
<td><input type="text" name="desig" value="<?php echo $row['desig'];?>" class="form-control" required></td>
</tr>
<tr>
